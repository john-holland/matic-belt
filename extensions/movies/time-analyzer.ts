...
export class TimeAnalyzer extends EventEmitter {
    ...
    private updateCoolingRate() {
        ...
        // Calculate base cooling rate based on media length
        ...
        const coolingRate = lengthBasedRate * timestampAdjustment;
    ...
    private calculateLengthBasedRate(): number {
        ...
        const lengthFactor = Math.log10(this.mediaLength) / Math.log10(3600); // Normalize to 1 hour
        return this.baseCoolingRate * (1 + lengthFactor * 0.1);
    }
    ...
    public getCurrentCoolingRate(): number {
        return this.calculateLengthBasedRate() * this.calculateTimestampAdjustment();
    }
